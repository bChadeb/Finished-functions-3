...
// CODE HERE
const evenNumbers = mixedNumbers.filter((evens) => {
  return evens % 2 === 0;
});
...
// CODE HERE
const postTaxPrices = prices.map((newPrices) => {
  return newPrices * 1.07;
});
...
// CODE HERE
const myStrongest = monstersInYourPocket.filter((strongPoints) => {
  return strongPoints.CP > 200;
});
