...
// const demNumbers = numbers.forEach((elem) => {
  // console.log(elem/2)
// })
...
const demNumbers = numbers.map(numnum => numnum / 2)

// console.log(demNumbers)
...
const cites = cities.filter(element => {
...
// const coloredFruit = fruits.forEach((elem, i) => {
//   if(elem.color.includes("red")){
//     console.log(`The fruit with the index ${i} is an apple`)
//   } else if(elem.color.includes("orange")){
...
const riceTotal = foods.reduce((acc, cur) => {
  if(cur.tags.includes("rice")){
